...
import { Vpc, AmazonLinuxGeneration, InstanceType, InstanceClass, InstanceSize } from "@aws-cdk/aws-ec2";
      ...
      "ComputeEnvironment",
      {
        computeResources: {
          ...
          instanceTypes: [
            ...
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE),
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE2),
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE4),
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE8),
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE12),
            InstanceType.of(InstanceClass.GRAPHICS4_NVME_DRIVE_HIGH_PERFORMANCE, InstanceSize.XLARGE16),
